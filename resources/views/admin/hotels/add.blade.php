            ...
            <form class="parsley-examples" action="{{route('hotel.store')}}" method="POST">
              ...
              <div class="form-group">
                ...
                <div class="custom-control custom-radio">
                  <input type="radio" id="customRadio1" value="0" name="view_sea" class="custom-control-input">
                  <label class="custom-control-label text-xs" for="customRadio1">Có</label>
                </div>
                <div class="custom-control custom-radio">
                  <input type="radio" id="customRadio2" value="1" name="view_sea" class="custom-control-input" checked>
              ...
              <div class="form-group">
                ...
                <div class="custom-control custom-radio">
                  <input type="radio" id="customRadio3" value="0" name="restaurant_coffee" class="custom-control-input">
                  <label class="custom-control-label text-xs" for="customRadio3">Có</label>
                </div>
                <div class="custom-control custom-radio">
                  <input type="radio" id="customRadio4" value="1" name="restaurant_coffee" class="custom-control-input" checked>
              ...
              <div class="form-group">
                <label>Wifi</label>
                <div class="custom-control custom-radio">
                  <input type="radio" id="customRadio5" value="0" name="wifi" class="custom-control-input">
                  <label class="custom-control-label text-xs" for="customRadio5">Có</label>
                </div>
                <div class="custom-control custom-radio">
                  <input type="radio" id="customRadio6" value="1" name="wifi" class="custom-control-input" checked>
              ...
              <div class="form-group">
                ...
                <div class="custom-control custom-radio">
                  <input type="radio" id="customRadio7" value="0" name="air_conditional" class="custom-control-input">
                  <label class="custom-control-label text-xs" for="customRadio7">Có</label>
                </div>
                <div class="custom-control custom-radio">
                  <input type="radio" id="customRadio8" value="1" name="air_conditional" class="custom-control-input" checked>
